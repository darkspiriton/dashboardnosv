...
angular.module('App', ['ngResource', 'ngMessages', 'ngSanitize', 'ngAnimate', 'toastr', 'ui.router', 'satellizer', 'angular-fb', 'doowb.angular-pusher']).config(["$stateProvider", "$urlRouterProvider", "$authProvider", "$fbProvider", "$locationProvider", "PusherServiceProvider", function ($stateProvider, $urlRouterProvider, $authProvider, $fbProvider, $locationProvider, PusherServiceProvider) {
    ...
    PusherServiceProvider.setToken('3af9472db014da6465ce').setOptions({});
    ...
    if ($auth.isAuthenticated()) {
        ...
        if (location.pathname != "/asociados/dashboard") $window.location.href = '/';
    }
...
//# sourceMappingURL=appBoss.js.map
