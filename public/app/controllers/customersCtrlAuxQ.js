angular.module('App')
    .config(function($stateProvider) {
        $stateProvider
            .state('customerAuxQ', {
                url: '/Adminitracion-de-coincidencias-clientes',
                templateUrl: 'app/partials/auxQCustomer.html',
                controller : 'productsCtrlAuxQ'
            });
    })
    .controller('productsCtrlAuxQ', function($scope, $compile, $state, $log, util, petition, toformData, toastr){

        util.liPage('customerAuxQ');
