    ...
    <ul class="main-menu">
        ...
        <li class="sub-menu">
            ...
            <ul>
                ...
                <li id="customerAuxQ">
                    <a ui-sref="customerAuxQ"><i class="md md-security"></i>Coincidencias de Clientes</a>
                </li>
                <li id="productAuxQ">
                    <a ui-sref="productAuxQ"><i class="md md-security"></i>Coincidencias de Productos</a>
                </li>
